...
export function RegisterPage({ auth }: RegisterPageProps) {
  ...
  function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    if (!isValid) {
      setError('Заполните поля и подтвердите согласие с условиями.')
      return
    }
  ...
  return (
    <div className="auth-card">
      <div className="auth-header">
        ...
        <h2>Создайте партнёрский аккаунт</h2>
        <p>Стартовый доступ — базовый. После активации сможете повышать уровень.</p>
      </div>
      <form className="auth-form" onSubmit={handleSubmit}>
        ...
        <label className="checkbox">
          ...
          />
          Согласен с условиями партнёрской программы
        </label>
